...
<body>
	...
	<div class="container">
		<h1 style="text-align: center;">Все песни</h1>
		<div class="songs"">
			<div class="column fl">
				<?php
						...
						foreach ($found_songs as $found_song) {
				    		if (isset($_SESSION['songsinbasket'][$found_song['id']])){
				    			if ($_SESSION['songsinbasket'][$found_song['id']] == 1){
				    				echo "<a href=\"?delete_song_id=".$found_song['id']."\"><h4 style=\"color: red;\">убрать из корзины</h4>";
				    			}
						...
						foreach ($songs as $song) {
				    		if (isset($_SESSION['songsinbasket'][$song->id])){
				    			if ($_SESSION['songsinbasket'][$song->id] == 1){
				    				echo "<a href=\"?delete_song_id=".$song->id."\"><h4 style=\"color: red;\">убрать из корзины</h4>";
				    			}
